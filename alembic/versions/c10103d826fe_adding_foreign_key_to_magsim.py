...
def upgrade():
    ...
    op.create_foreign_key('magasin_invoice_fk', source_table="invoices", referent_table="magasins", local_cols=[
    ...
    op.create_foreign_key('magasin_depense_fk',source_table='depenses',referent_table="magasins",local_cols=[
        'magasin_id'],remote_cols=['id'], ondelete="CASCADE")
